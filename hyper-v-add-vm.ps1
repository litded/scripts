...
# Установите ос, и экспортируйте в любую папку, а затем перенесите диск в тапку на которую указывает переменная $iso
# Чтобы получить ip на воследнем шаге в debian 10 и ниже, установите:
